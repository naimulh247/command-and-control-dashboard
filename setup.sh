...
echo "Are you installing packages for the (1) robot or the (2) web-client?"
read -p "Enter 1 for robot or 2 for web-client: " choice
...
if [[ $choice -eq 1 ]]; then
    ...
    echo "Invalid choice. Please enter 1 for robot or 2 for web-client."
    exit 1
fi
